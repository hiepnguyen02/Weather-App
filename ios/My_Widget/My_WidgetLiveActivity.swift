...
struct My_WidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = My_WidgetAttributes(name: "Me")
    static let contentState = My_WidgetAttributes.ContentState(value: 3)
